...
args['image'] = "./example-images/Example-images/4.jpeg"
...
if len(boxes) == 0:
    fileOpen.write(str('Please enter a Valid image\n'))
...
for ((start_X, start_Y, end_X, end_Y), text) in results:
    ...
    try:
        ...
        outputText = obj.translate(from_lang='en', to='hi')
    except:
        outputText = "Please enter a meaningful word/sentence"
    fileOpen.write(str(outputText) + '\n')
...
# outputSTR = obj.translate(from_lang='hi', to='en')
# fileOpen = open("results.txt", "w")
# fileOpen.write(str(outputSTR))
# fileOpen.close()
